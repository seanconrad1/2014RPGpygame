...
'''pygame.mixer.init()
pygame.init()
pygame.mixer.music.load("data/music/Tristram.wav")
...
def begin():
	...
	functs.slowText('''Struggling to stand, you see that you are not far 
from your home and stagger to it.''')
	functs.slowText('''Upon grabbing the door handle, a man grabs your 
shoulder and shouts "Who are you!?"(Enter name)''')
	name = raw_input()
